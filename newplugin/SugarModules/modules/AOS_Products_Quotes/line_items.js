...
function insertProductLine(tableid, groupid) {
  ...
  f.innerHTML = "<input type='text' name='product_vat_amt[" + prodln + "]' id='product_vat_amt" + prodln + "' maxlength='250' value='' title='' tabindex='116' readonly='readonly' class='product_vat_amt_text' style='display:none'>";
  f.innerHTML += "<select tabindex='116' name='product_vat[" + prodln + "]' id='product_vat" + prodln + "' onchange='calculateLine(" + prodln + ",\"product_\");' class='product_vat_amt_select' style='display:none'>" + vat_hidden + "</select>";
...
function insertServiceLine(tableid, groupid) {
  ...
  var c = x.insertCell(4);
  c.innerHTML = "<input type='text' name='service_vat_amt[" + servln + "]' id='service_vat_amt" + servln + "' maxlength='250' value='' title='' tabindex='116' readonly='readonly' class='service_vat_text' style='display:none;'>";
  c.innerHTML += "<select tabindex='116' name='service_vat[" + servln + "]' id='service_vat" + servln + "' onchange='calculateLine(" + servln + ",\"service_\");' class='service_vat_select'style='display:none;' >" + vat_hidden + "</select>";
  if (typeof currencyFields !== 'undefined'){
...
function insertGroup()
{
  ...
  if(enable_groups){
    ...
    footer_cell4.innerHTML="<span class='totals'><label style='display:none;'>"+SUGAR.language.get(module_sugar_grp1, 'LBL_TAX_AMOUNT')+":</label><input name='group_tax_amount[]' id='"+ table.id +"tax_amount' class='group_tax_amount' maxlength='26' value='' title='' tabindex='120' type='text' readonly style='display:none'></span>";
    ...
    footer_cell6.innerHTML="<span class='totals'><label style='display:none'>"+SUGAR.language.get(module_sugar_grp1, 'LBL_GROUP_TOTAL')+":</label><input name='group_total_amount[]' id='"+ table.id +"total_amount' class='group_total_amount'  maxlength='26' value='' title='' tabindex='120' type='text' readonly style='display:none'></span>";
...
// my changess...................
$(document).on("change","#global_tax_c",function(){
 var global_tax_c1=$('#global_tax_c').val();
 var global_tax_c=unformat2Number(global_tax_c1);
	var key = 'lineItems';
  ...
  var shippingtax_amt = subtotal * (global_tax_c/100);

  set_value(key+'total_amount',subtotal + shippingtax_amt);
...
function calculateTotal(key)
{
 ...
 var global_tax_c=unformat2Number(global_tax_c1);
  ...
  var shippingtax_amt1 = subtotal * (global_tax_c/100);

  set_value('total_amount',subtotal + shippingtax_amt1);
}
