...
<div class="detail-view">
    ...
    <ul class="nav nav-tabs">
        ...
        *}
        ...
        <li id="tab-actions" class="">
            <a href="index.php?entryPoint=Pandaredirect&id={$fields.id.value}" class="button primary" >{$MOD.LBL_PANDADOC_SEND}</a>
        </li>
        {/if}
        {if $module==AOS_Quotes}
        <li id="tab-actions" class="">
            <a href="index.php?entryPoint=QuotePandaredirect&id={$fields.id.value}" class="button primary" >{$MOD.LBL_PANDADOC_SEND_QUOTE}</a>
        </li>
        {/if}
